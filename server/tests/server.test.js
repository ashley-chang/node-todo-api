...
describe('DELETE /todos/:id', () => {
  it('should remove a todo', (done) => {
    var someID = todos[1]._id.toHexString();
  ...
  it('should not remove a todo if attempted by different user', (done) => {
...
describe('PATCH /todos/:id', () => {
  ...
  //duplicate above test, update first todo as second user, get 404 back
